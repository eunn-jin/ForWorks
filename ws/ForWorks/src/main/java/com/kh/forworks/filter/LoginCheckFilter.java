...
public class LoginCheckFilter implements Filter{
	...
	private static final String[] whiteList = {"/forworks/login", "/forworks/join"};
	//체크할 주소들
	private static final String[] blackList = {"/forworks/att/*", "/forworks/off/*"};
...
//		System.out.println(requestURI);
		...
		if(isLoginCheckPath(requestURI)) {
			...
			if(session == null || session.getAttribute("loginMember") == null) {
				httpResponse.sendRedirect("/forworks/login");
				return;
			} else {
